...
const Button = ({ children }) => {
  return (
    <div className="relative overflow-hidden group rounded-full px-1">
      <div className="absolute inset-0 transition-transform duration-300 ease-in-out group-hover:-translate-y-2 group-hover:scale-50"></div>
      <div className="relative transition-transform duration-300 ease-in-out group-hover:-translate-y-2 group-hover:scale-50">
        <span className="inline-block px-4 py-1 whitespace-nowrap">
          {children}
        </span>
      </div>
